...
public class DianyingChangciView extends DianyingChangciEntity implements Serializable {
	...
	public DianyingChangciView() {

	}

	public DianyingChangciView(DianyingChangciEntity dianyingChangciEntity) {
		try {
			BeanUtils.copyProperties(this, dianyingChangciEntity);
